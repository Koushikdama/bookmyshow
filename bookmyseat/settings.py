...
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels_redis.core.RedisChannelLayer',
        'CONFIG': {
            'hosts': ['redis://default:CTSPy0opsMmRoYUTBRqdjku8QT0Fp6QI@redis-15594.c267.us-east-1-4.ec2.redns.redis-cloud.com:15594'],
        },
    },
}
...
DATABASES['default'] = dj_database_url.parse('postgresql://django_bookmyshow_nqpy_user:tFMIlzSh323Jsrz5J7POb5QPqeHnlHd1@dpg-ctdh71d2ng1s73d6j13g-a.oregon-postgres.render.com/django_bookmyshow_nqpy')
